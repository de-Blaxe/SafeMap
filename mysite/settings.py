...
if os.getenv('GAE_APPLICATION', None):
    ...
    # the unix socket at /cloudsql/infodb-instance
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'HOST': '/cloudsql/eng-artifact-265522:us-west1:infodb-instance',
            'USER': 'HD2020',
    ...
    #
    #     $ cloud_sql_proxy -instances=infodb-instance=tcp:3306
    #
